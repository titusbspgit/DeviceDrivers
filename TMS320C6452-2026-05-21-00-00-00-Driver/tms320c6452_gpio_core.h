...
/* Base address (from provided configuration) */
...
#define GPIO_BANK_FROM_PIN(n)       ( (uint32_t)(n) >> 4 )  /* 0 for 0..15, 1 for 16..31 */

/* Core operations interface exposed to feature drivers */
typedef struct {
    uintptr_t base;
...
/* Low-level barriers for deterministic MMIO ordering */
...
/* Get a pointer to the statically defined core interface. */

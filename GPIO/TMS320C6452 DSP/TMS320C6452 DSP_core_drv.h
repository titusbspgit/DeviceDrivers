 ...
 * This header provides reusable MMIO helpers and function table for feature drivers.
 */
...
/* Base address as per global configuration */
#define TMS320C6452_DSP_BASE   (0xA1008000u)

/* Generic register offset helper macro */

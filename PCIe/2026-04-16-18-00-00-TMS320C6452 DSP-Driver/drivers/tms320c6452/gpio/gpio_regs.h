...
// Base address default (can be overridden in init)
...
// Helpers for pin bit within 32-bit 2-bank register
#define GPIO_PIN_BIT(pin)               ((uint32_t)1u << (uint32_t)((pin) & 31u))
#define GPIO_BANK_FROM_PIN(pin)         ((uint32_t)((pin) >> 4) & 0x1u) // 0: [0..15], 1: [16..31]

...
/* File: drivers/tms320c6452/gpio/gpio.c */
/* RCI-ag-DrvGen Agent - TMS320C6452 DSP GPIO Driver Implementation */
#include "gpio.h"

/* Weak default platform hooks (override in app/test as needed) */

 ...
 *
 * RCI-ag-DrvGen Agent: RCI-ag-DrvGen Agent (RCI-ag-DrvGen)
 *
 * This driver follows MISRA-style discipline where practical and avoids
 * undefined behavior. All MMIO accesses are 32-bit and deterministic.
 */
